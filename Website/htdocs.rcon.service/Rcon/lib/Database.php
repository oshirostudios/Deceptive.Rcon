<?php
include RCON_PATH . 'lib/libraries/adodb/adodb.inc.php';
require_once RCON_PATH . 'lib/libraries/adodb/adodb-xmlschema.inc.php';
...
class PearDatabase
{
	...
	function println($msg) { return $msg; }
...
$adb = new PearDatabase($CONFIG['db_settings']['db_type'],
	$CONFIG['db_settings']['db_host'],
	$CONFIG['db_settings']['db_name'],
	$CONFIG['db_settings']['db_username'],
	$CONFIG['db_settings']['db_password']);

$adb->connect();
$adb->prefix = $CONFIG['db_table_prefix'];
?>
